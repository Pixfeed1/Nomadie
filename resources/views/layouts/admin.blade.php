    ...
    <div x-data="{ sidebarOpen: true, userDropdownOpen: false, modalOpen: false }" class="flex min-h-screen">
        ...
        >
            ...
            <nav class="p-4 space-y-2 overflow-y-auto">
                ...
                <a href="{{ route('admin.trips.index') }}" class="sidebar-link flex items-center px-4 py-3 rounded-lg text-text-primary hover:text-primary transition-colors {{ request()->routeIs('admin.trips*') ? 'active' : '' }}">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <p class="mt-6 px-4 text-xs font-semibold text-text-secondary uppercase tracking-wider">Configuration</p>

                <a href="{{ route('admin.countries.index') }}" class="sidebar-link flex items-center px-4 py-3 rounded-lg text-text-primary hover:text-primary transition-colors {{ request()->routeIs('admin.countries*') ? 'active' : '' }}">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3.055 11H5a2 2 0 012 2v1a2 2 0 002 2 2 2 0 012 2v2.945M8 3.935V5.5A2.5 2.5 0 0010.5 8h.5a2 2 0 012 2 2 2 0 104 0 2 2 0 012-2h1.064M15 20.488V18a2 2 0 012-2h3.064M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                    </svg>
                    <span>Pays</span>
                ...
                <a href="{{ route('admin.settings.hero-banner') }}" class="sidebar-link flex items-center px-4 py-3 rounded-lg text-text-primary hover:text-primary transition-colors {{ request()->routeIs('admin.settings*') ? 'active' : '' }}">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z" />
                    </svg>
                    <span>Bandeau d'accueil</span>
                </a>
