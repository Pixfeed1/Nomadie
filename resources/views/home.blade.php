    ...
    <div class="relative text-white" style="background: linear-gradient(135deg, #1d5554 0%, #2a7573 100%);">
        ...
        <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
            <div class="text-center">
                <h2 class="text-3xl md:text-4xl font-bold text-white mb-6">Partagez votre expérience</h2>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl mx-auto mb-10">
                    <div class="flex flex-col items-center">
                        ...
                        <p class="text-white font-semibold mb-1">Écrivez</p>
                        <p class="text-white/80 text-sm">Partagez vos récits de voyage</p>
                    </div>
                    <div class="flex flex-col items-center">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-12 w-12 text-white mb-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z" />
                        </svg>
                        <p class="text-white font-semibold mb-1">Communauté</p>
                        <p class="text-white/80 text-sm">Rejoignez les passionnés de voyage</p>
                    </div>
                    <div class="flex flex-col items-center">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-12 w-12 text-white mb-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        ...
                        <p class="text-white font-semibold mb-1">Visibilité</p>
                        <p class="text-white/80 text-sm">Inspirez des milliers de lecteurs</p>
                    </div>
                </div>

                <a href="{{ route('writer.register') }}" class="inline-flex items-center justify-center px-8 py-4 border border-transparent text-lg font-medium rounded-md shadow-sm bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-white transition-colors" style="color: #1d5554;">
                    Devenir rédacteur
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 ml-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 8l4 4m0 0l-4 4m4-4H3" />
                    </svg>
