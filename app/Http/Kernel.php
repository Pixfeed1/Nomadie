...
class Kernel extends HttpKernel
{
    ...
    protected $middlewareGroups = [
        ...
        // Groupe pour inscription vendeur
        'vendor_registration' => [
            \App\Http\Middleware\EncryptCookies::class,
            \Illuminate\Cookie\Middleware\AddQueuedCookiesToResponse::class,
            \Illuminate\Session\Middleware\StartSession::class,
            ...
            \App\Http\Middleware\VerifyCsrfToken::class,
            \Illuminate\Routing\Middleware\SubstituteBindings::class,
            \App\Http\Middleware\VendorRegistrationMiddleware::class,
            \App\Http\Middleware\SessionPersistenceMiddleware::class,
            \App\Http\Middleware\SessionDebugMiddleware::class,
        ],

        // Groupe pour dashboard vendeur
        'vendor_dashboard' => [
            \App\Http\Middleware\EncryptCookies::class,
            \Illuminate\Cookie\Middleware\AddQueuedCookiesToResponse::class,
            \Illuminate\Session\Middleware\StartSession::class,
        ...
        // NOUVEAU : Groupe pour dashboard client
        'customer_dashboard' => [
            \App\Http\Middleware\EncryptCookies::class,
            \Illuminate\Cookie\Middleware\AddQueuedCookiesToResponse::class,
            \Illuminate\Session\Middleware\StartSession::class,
    ...
    protected $routeMiddleware = [
        ...
        'session.persist' => \App\Http\Middleware\SessionPersistenceMiddleware::class,
